...
import pipelineModule from '../Stage_10_input_understanding/pipeline.js';
import visionModule from '../Stage_10_input_understanding/vision.js';
import core from '../Construction_core/index.js';

const root = resolve(dirname(fileURLToPath(import.meta.url)), '..');
const taskRoot = resolve(root, '_tasks/alpha-construction-core');
const e2eFixturesRoot = resolve(root, 'Stage_10_input_understanding/fixtures/e2e');
...
const goldenConfirmed = JSON.parse(readFileSync(resolve(taskRoot, 'GOLDEN_INPUT_KITCHEN_2025-04-01.json'), 'utf8'));

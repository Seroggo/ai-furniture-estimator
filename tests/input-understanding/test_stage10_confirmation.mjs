...
import confirmation from '../../src/input-understanding/confirmation.js';

const root = resolve(dirname(fileURLToPath(import.meta.url)), '../..');
const taskRoot = resolve(root, 'contracts/input-understanding');
const fixturesRoot = resolve(root, 'fixtures/input-understanding');

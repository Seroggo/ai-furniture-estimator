...
import { runConstructionFromDraft, RunConstructionFromDraft } from '../Stage_10_input_understanding/construction_adapter.js';
...
const confirmedSchema = JSON.parse(readFileSync(resolve(taskRoot, 'CONFIRMED_CONFIGURATION_V1.schema.json'), 'utf8'));

...
const input = JSON.parse(readFileSync(resolve(root, 'fixtures/construction/GOLDEN_INPUT_KITCHEN_2025-04-01.json'), 'utf8'));
...
const schema = JSON.parse(readFileSync(resolve(root, 'contracts/construction/CONFIRMED_CONFIGURATION_V1.schema.json'), 'utf8'));
